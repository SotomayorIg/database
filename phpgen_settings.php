...
function GetGlobalConnectionOptions()
{
    return
        array(
          'server' => 'localhost',
          'port' => '3306',
          'password' => '}AD@S51x0|wUqcI4',
          'username' => 'id17893240_ignacio',
          'database' => 'id17893240_siempreenforma',
...
{
    $result = array();
    $result[] = array('caption' => 'Clases', 'short_caption' => 'Clases', 'filename' => 'clases.php', 'name' => 'clases', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Profesores', 'short_caption' => 'Profesores', 'filename' => 'profesores.php', 'name' => 'profesores', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    $result[] = array('caption' => 'Socios', 'short_caption' => 'Socios', 'filename' => 'socios.php', 'name' => 'socios', 'group_name' => 'Default', 'add_separator' => false, 'description' => '');
    return $result;
}
